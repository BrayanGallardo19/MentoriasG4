...
export default function Login() {
  ...
  const loginTestUser = (testEmail: string, testPassword: string) => {
    const success = login(testEmail, testPassword);
    if (success) {
      navigate("/");
    }
  };
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-md w-full">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-8">
            ...
            {/* Role Selector - Solo para registro */}
            {mode === "register" && (
              <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <p className="text-sm text-yellow-800">
                  El registro no está disponible en este momento. Por favor, usa
                  una de las cuentas de prueba.
                </p>
              </div>
            )}
